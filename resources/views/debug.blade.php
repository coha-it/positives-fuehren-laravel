...
<html lang="en">
	<head>
	    ...
	    <title>Urip Landing Page Template - Hero Subscribe Layout</title>
		...
		<!-- Font Icon -->
		<link rel="stylesheet" href="old/fonts/icomoon/icomoon.css">

		<!-- Swipebox -->
		<link rel="stylesheet" href="old/css/swipebox.css">

		<!-- Animate CSS -->
		<link rel="stylesheet" href="old/css/animate.min.css">

		<!-- Custom CSS -->
		<link rel="stylesheet" href="old/css/style-v2.css">
		<link rel="stylesheet" href="old/css/style-responsive-v2.css">
		<link rel="stylesheet" href="old/css/expandableGallery.css">
	    ...
	    <![endif]-->
	    <script src="old/js/modernizr.js"></script> <!-- Modernizr -->

	    <!-- FAV AND TOUCH ICONS -->
	    <link rel="shortcut icon" href="old/images/favicon/favicon.ico">

	    <link rel="icon" type="image/png" href="old/images/favicon/favicon-32.png">

	    <!-- For iPad with high-resolution Retina display running iOS ≥ 7: -->
		<link rel="apple-touch-icon-precomposed" sizes="152x152" href="old/images/favicon/apple-touch-icon-152.png">

		<!-- For iPad with high-resolution Retina display running iOS ≤ 6: -->
		<link rel="apple-touch-icon-precomposed" sizes="144x144" href="old/images/favicon/apple-touch-icon-144.png">

		<!-- For iPhone with high-resolution Retina display running iOS ≥ 7: -->
		<link rel="apple-touch-icon-precomposed" sizes="114x114" href="old/images/favicon/apple-touch-icon-114.png">

		<!-- For iPad and iPad mini models with a 1× display -->
		<link rel="apple-touch-icon-precomposed" sizes="76x76" href="old/images/favicon/apple-touch-icon-76.png">

		<!-- For first- and second-generation iPad: -->
		<link rel="apple-touch-icon-precomposed" sizes="72x72" href="old/images/favicon/apple-touch-icon-72.png">

		<!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
		<link rel="apple-touch-icon-precomposed" href="old/images/favicon/apple-touch-icon-57.png">
  	...
  	<body>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<a href="#0" class="logo"><img src="old/images/logo.png" alt="Urip Logo"></a> <!-- Your Logo -->
		...
		========================
		-->
		<main id="main-content" class="hero-subscribe-layout" style="margin-bottom: 234px;"> <!-- margin value is the height of your footer -->
			...
			========================
			-->
			<section id="hero" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
							...
							<div class="vertical-center-content">
								...
								<div class="hero-content row centered">
									<div class="col-lg-12">
										...
										<p class="lead all-caps text-shadow-small" data-sr="enter top over 1s and move 50px wait 0.4s">Meet Urip Landing Page Template</p>

										<h1 class="all-caps text-shadow-medium" data-sr="enter top over 1s and move 50px wait 0.3s">All in One Landing Page that Converts</h1>
										...
										<div class="row">
											<div class="hero-subscribe-wrapper col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
												...
												<form id="hero-subscribe" class="the-subscribe-form" data-sr="enter bottom over .5s and move 10px wait 0.3s">

													<div class="input-group">
														<input type="email" class="form-control" placeholder="Enter Your Email">
														<span class="input-group-btn">
															<button class="btn btn-subscribe" id="header-subscribe" type="submit">Get Access</button>
														</span>
											        </div> <!--/ .input-group -->

												</form> <!--/ #hero-subscribe -->

										        <small class="helper-text" data-sr="enter bottom over .5s and move 50px wait 0.3s"> <em>Don't worry we will never give your email address to others.</em></small>

											</div><!--/ .hero-subscribe-wrapper -->
										</div> <!--/ .row -->
										<!--/ End Hero Subscribe -->

										<div data-sr="enter top over 1s and move 50px wait 0.5s">
											<a href="https://www.youtube.com/watch?v=mdfMT5Zi8Eo" class="swipebox-video cta cta-transparent all-caps" rel="vimeo"> Watch Video <span class="icon-youtube5"></span></a>
										</div>
					...
					<div class="row">
						...
						<div class="client-logo">
							...
							<div class="the-logo col-lg-2 col-md-2 col-sm-3 col-xs-3">
								...
								<a href="#0"><img src="old/images/client/client.png" alt="Client Logo" data-sr="scale up 30% wait .2s"/></a>

							</div> <!--/ .the-logo -->

							<div class="the-logo col-lg-2 col-md-2 col-sm-3 col-xs-3">

								<a href="#0"><img src="old/images/client/client.png" alt="Client Logo" data-sr="scale up 30% wait .5s"/></a>

							</div> <!--/ .the-logo -->

							<div class="the-logo col-lg-2 col-md-2 col-sm-3 col-xs-3">

								<a href="#0"><img src="old/images/client/client.png" alt="Client Logo" data-sr="scale up 30% wait .7s"/></a>

							</div> <!--/ .the-logo -->

							<div class="the-logo col-lg-2 col-md-2 col-sm-3 col-xs-3">

								<a href="#0"><img src="old/images/client/client.png" alt="Client Logo" data-sr="scale up 30% wait .9s"/></a>

							</div> <!--/ .the-logo -->

							<div class="the-logo col-lg-2 col-md-2 hidden-sm hidden-xs">

								<a href="#0"><img src="old/images/client/client.png" alt="Client Logo" data-sr="scale up 30% wait 1.1s"/></a>
						...
						<ul class="how-it-works-col">
							...
							<li class="col-lg-4 col-md-4 col-sm-4">
								<div class="how-it-works-title">
									...
									<img src="old/images/219x176.png" alt="Fully Responsive" data-sr="enter bottom over 1s and move 80px wait 0.3s">
							...
							<li class="col-lg-4 col-md-4 col-sm-4">
								<div class="how-it-works-title">
									...
									<img src="old/images/219x176.png" alt="Fully Responsive" data-sr="enter bottom over 1s and move 80px wait 0.5s">
							...
							<li class="col-lg-4 col-md-4 col-sm-4">
								<div class="how-it-works-title">
									...
									<img src="old/images/219x176.png" alt="Fully Responsive" data-sr="enter bottom over 1s and move 80px wait 0.7s">
					...
					<div class="row">
						...
						<div class="expandable-gallery-wrapper col-lg-6 col-md-6 no-padding">
							...
							<ul class="expandable-gallery-item">
								<li class="selected"><img src="old/images/stocks/stock1.jpg" alt="Photo Stocks"></li>
								<li><img src="old/images/stocks/stock2.jpg" alt="Photo Stocks"></li>
								<li><img src="old/images/stocks/stock3.jpg" alt="Photo Stocks"></li>
			...
			===========================
			-->
			<section id="counter" class="breaking centered" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="40">
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane fade in active" id="one">
									...
									<div class="col-lg-6 col-md-6" data-sr="enter left over 1s and move 110px">
										<img class="animated fadeInLeft margin-bot-8 large-image-mockup" src="old/images/mockup/imac.png" alt="iMac Mockup"/>
									</div> <!--/ .col-lg-6 -->
									...
									<div class="col-lg-6 col-md-6" data-sr="enter right over 1s and move 110px">
										...
										<div class="panel-group accordion-wrapper animated fadeInRight" id="accordion" role="tablist" aria-multiselectable="true">
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="first_accordion_heading">
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading panel-active" role="tab" id="second_accordion_heading">
								...
								<div role="tabpanel" class="tab-pane fade" id="two">
									...
									<div class="col-lg-10 col-lg-offset-1 centered">
										...
										<div class="browser-mockup-wrapper animated fadeInUp">
											...
											<a href="https://www.youtube.com/watch?v=mdfMT5Zi8Eo" class="swipebox-video play-btn animated pulse"><span class="icon-play2"></span></a>
											<img class="margin-top-40" src="old/images/mockup/browser.png" alt="Browser Mockup" />
					...
					<div class="row">
						...
						<div class="the-team-wrapper">
							...
							<div class="col-lg-3 col-md-3">
								...
								<ul class="filter">
									<li><a href="#0" class="active" data-filter="*">Everyone</a></li>
									<li><a href="#0" data-filter=".manager">Manager</a></li>
									<li><a href="#0" data-filter=".developer">Developer</a></li>
									<li><a href="#0" data-filter=".designer">Designer</a></li>
									<li><a href="#0" data-filter=".marketing">Marketing</a></li>
									<li><a href="#0" data-filter=".support">Support</a></li>
								</ul> <!--/ .filter -->
									...
									<div class="vertical-center-wrapper">
										<div class="vertical-center-table">
											<div class="vertical-center-content">
												...
												<img class="customer-logo" src="old/images/client/client.png" alt="Customer Logo" data-sr="scale up 30%" /> <!--/ .customer-logo -->
									...
									<div class="vertical-center-wrapper">
										<div class="vertical-center-table">
											<div class="vertical-center-content">
												...
												<img class="customer-logo" src="old/images/client/client.png" alt="Customer Logo" data-sr="scale up 30% wait .2s"/> <!--/ .customer-logo -->
									...
									<div class="vertical-center-wrapper">
										<div class="vertical-center-table">
											<div class="vertical-center-content">
												...
												<img class="customer-logo" src="old/images/client/client.png" alt="Customer Logo" data-sr="scale up 30% wait .4s"/> <!--/ .customer-logo -->
									...
									<div class="vertical-center-wrapper">
										<div class="vertical-center-table">
											<div class="vertical-center-content">
												...
												<img class="customer-logo" src="old/images/client/client.png" alt="Customer Logo" data-sr="scale up 30% wait .6s"/> <!--/ .customer-logo -->
									...
									<div class="vertical-center-wrapper">
										<div class="vertical-center-table">
											<div class="vertical-center-content">
												...
												<img class="customer-logo" src="old/images/client/client.png" alt="Customer Logo" data-sr="scale up 30% wait .8s"/> <!--/ .customer-logo -->
									...
									<div class="vertical-center-wrapper">
										<div class="vertical-center-table">
											<div class="vertical-center-content">
												...
												<img class="customer-logo" src="old/images/client/client.png" alt="Customer Logo" data-sr="scale up 30% wait 1s"/> <!--/ .customer-logo -->
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-3 col-lg-offset-2 col-md-3 col-md-offset-2 col-sm-4 centered">
									...
									<img class="subscribe-icon" src="old/images/132x149.png" alt="Open Envelope Icon" data-sr="scale up 40% wait .2s"/>
		...
		<!-- SmoothScroll -->
		<script src="old/js/minified/SmoothScroll.min.js"></script>

		<!-- Classie -->
		<script src="old/js/minified/classie.min.js"></script>

		<!-- One Page Nav -->
		<script src="old/js/minified/jquery.nav.min.js"></script>

		<!-- AjaxChimp -->
		<script src="old/js/minified/jquery.ajaxchimp.min.js"></script>

		<!-- Swipebox -->
		<script src="old/js/minified/jquery.swipebox.min.js"></script>

		<!-- Expandable Gallery on 2 Block Column -->
		<script src="old/js/minified/expandableGallery.min.js"></script>

		<!-- Counter Up -->
		<script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script>
		<script src="old/js/minified/jquery.counterup.min.js"></script>

		<!-- Isotope JS -->
		<script src="https://npmcdn.com/isotope-layout@3.0/dist/isotope.pkgd.min.js"></script>
		<script src="old/js/urip-isotope-setting.js"></script>

		<!-- Headhesive -->
		<script src="old/js/minified/headhesive.min.js"></script>

		<!-- ScrollReveal -->
		<script src="old/js/minified/scrollReveal.min.js"></script>

		<!-- Stellar JS -->
		<script src="old/js/jquery.stellar.js"></script>

		<!-- Custom JS -->
		<script src="old/js/urip-v2.js"></script>

		<!-- Expandable Navigation Menu -->
		<script src="old/js/minified/expandableNav.min.js"></script>
