...
<html lang="en">
	<head>
	    ...
	    <title>Positive Psychologie für Führungskräfte</title>
		...
		<!-- Font Icon -->
		<link rel="stylesheet" href="{{ asset('old/fonts/icomoon/icomoon.css') }}">

		<!-- Swipebox -->
		<link rel="stylesheet" href="{{ asset('old/css/swipebox.css') }}">

		<!-- Animate CSS -->
		<link rel="stylesheet" href="{{ asset('old/css/animate.min.css') }}">

		<!-- Custom CSS -->
		<link rel="stylesheet" href="{{ asset('old/css/style-v2.css') }}">
	    ...
	    <![endif]-->
	    <script src="{{ asset('old/js/modernizr.js') }}"></script> <!-- Modernizr -->
  	...
  	<body>
		...
		<main id="main-content" class="hero-subscribe-layout" style="margin-bottom: 234px;"> <!-- margin value is the height of your footer -->
	        ...
	        <!--
			=============================
			== BEGIN IMPRESSUM SECTION ==
			=============================
			-->
			
            			
<div class="main-content" style="padding-top: 80px; margin-left: 60px; text-align: left;">
	<div class="container">
		<div class="row">
...
<p>Corporate Happiness GmbH<br />
Maria-Josepha-Straße 14<br />
D-80802 München</p>
<h2>Vertreten durch:</h2>
<p>Dr. Oliver Haas</p>
<h2>Kontakt:</h2>
<p>Telefon: +49 – 89 890 67 31 77<br />
E-Mail: <a href="mailto:&#105;n&#102;&#111;&#64;cor&#112;o&#114;&#97;&#116;&#101;-h&#97;ppine&#115;s.d&#101;">&#105;&#110;&#102;o&#64;c&#111;r&#112;orat&#101;&#45;h&#97;pp&#105;n&#101;ss.&#100;&#101;</a></p>
<h2>Registereintrag:</h2>
<p>Registergericht: Handelsregister B München<br />
Registernummer: 185900Umsatzsteuer-ID: DE 271 823 276</p>
<h2>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</h2>
<p>Dr. Oliver Haas</p>
<h2>Quellenangaben für die verwendeten Bilder und Grafiken:</h2>
<p><strong>Bilder:</strong><br />
Unsplash- <a href="http://www.unsplash.com">www.unsplash.com</a><br />
Fotolia &#8211; <a href="http://www.fotolia.com">www.fotolia.com</a></p>
<p>Quelle: <i>Erstellt mit dem <a title="Impressum-Generator" href="http://www.mth-partner.de/impressumgenerator/impressum-generator.php" target="_blank" rel="noopener noreferrer"><span style="color: #373737;">Impressum-Generator</span></a> von </i> <i><a href="http://www.mth-partner.de/leistungen-rechtsanwalt-koeln/arbeitsrecht/" target="_blank" rel="noopener noreferrer"><span style="color: #373737;">Tieben &amp; Partner, Rechtsanwalt für Arbeitsrecht in Köln</span></a></i></p>
...
<p>Auf unseren Seiten sind Plugins des sozialen Netzwerks Facebook, 1601 South California Avenue, Palo Alto, CA 94304, USA integriert. Die Facebook-Plugins erkennen Sie an dem Facebook-Logo oder dem „Like-Button“ („Gefällt mir“) auf unserer Seite. Eine übersicht über die Facebook-Plugins finden Sie hier: <a href="http://developers.facebook.com/docs/plugins/" target="_blank" rel="noopener noreferrer"><span style="color: #373737;">http://developers.facebook.com/docs/plugins/</span></a>.<br />
Wenn Sie unsere Seiten besuchen, wird über das Plugin eine direkte Verbindung zwischen Ihrem Browser und dem Facebook-Server hergestellt. Facebook erhält dadurch die Information, dass Sie mit Ihrer IP-Adresse unsere Seite besucht haben. Wenn Sie den Facebook „Like-Button“ anklicken während Sie in Ihrem Facebook-Account eingeloggt sind, können Sie die Inhalte unserer Seiten auf Ihrem Facebook-Profil verlinken. Dadurch kann Facebook den Besuch unserer Seiten Ihrem Benutzerkonto zuordnen. Wir weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der übermittelten Daten sowie deren Nutzung durch Facebook erhalten. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von facebook unter <a href="http://de-de.facebook.com/policy.php" target="_blank" rel="noopener noreferrer"><span style="color: #373737;"> http://de-de.facebook.com/policy.php</span></a></p>
...
<p>Wir weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der übermittelten Daten sowie deren Nutzung durch Twitter erhalten. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Twitter unter <a href="http://twitter.com/privacy" target="_blank" rel="noopener noreferrer"><span style="color: #373737;">http://twitter.com/privacy</span></a>.</p>
<p>Ihre Datenschutzeinstellungen bei Twitter können Sie in den Konto-Einstellungen unter <a href="http://twitter.com/account/settings" target="_blank" rel="noopener noreferrer"><span style="color: #373737;">http://twitter.com/account/settings</span></a> ändern.</p>
</div>
			</div><!-- .entry-content -->
	</article><!-- #post-## -->
			...
			<div class="container">
				<div class="row">
					...
					<div class="copyright">
                        ...
                        <p>Copyright: Corporate Happiness® 2018 -</p>
                        <p>E-Mail:</p>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6">
										...
										<div class="required-field">
											<input name="fname" id="fname" class="contact-input"  type="text" placeholder="Vorname">
										</div> <!--/ .required-field -->
									...
									<div class="col-lg-6 col-md-6">
										...
										<div class="required-field">
											<input name="lname" id="lname" class="contact-input" type="text" placeholder="Nachname">
										</div>
									...
									<div class="col-lg-12 col-md-12">
										...
										<div class="required-field">
											<input name="email" id="email" class="contact-input" type="email" placeholder="E-Mail-Adresse">
										</div> <!--/ .required-field -->
									...
									<div class="col-lg-12 col-md-12">
										<div class="required-field">
											<input name="subject" id="subject" class="contact-input" type="text" placeholder="Betreff">
										</div>
									...
									<div class="col-lg-12 col-md-12">
										...
										<div class="required-field">
											<textarea name="message" id="message" rows="9" placeholder="Ihre Nachricht"></textarea>
										</div> <!--/ .required-field -->
									...
									<div class="col-lg-12 col-md-12 all-caps centered">
										...
										<button id="submit" type="submit" class="submit-btn">Abschicken</button>
		...
		<div id="subscribe-error-notification" class="notif-box">
			...
			<p>Fehler bei der Anmeldung, bitte überprüfen Sie Ihre E-Mail-Adresse.</p>
			<a class="notification-close">Schließen</a>
		...
		<div id="subscribe-success-notification" class="notif-box">
			...
			<p>Ihre Anmeldung zum Newsletter war erfolgreich.</p>
			<a class="notification-close">Schließen</a>
		...
		<div id="error-notification" class="notif-box">
			...
			<span class="icon-bullhorn notif-icon"></span>
			<p>Es gab ein Problem bei Ihrer Anmeldung. Bitte überprüfen Sie die rot-markierten Felder.</p>
		...
		<div id="success-notification" class="notif-box">
			...
			<span class="icon-checkmark notif-icon"></span>
			<p>Ihre Nachricht wurde verschickt. Wir melden uns zeitnah bei Ihnen!</p>
			<a class="notification-close">Schließen</a>
		...
		<!-- AjaxChimp -->
		<script src="{{ asset('old/js/minified/jquery.ajaxchimp.min.js') }}"></script>

		<!-- Swipebox -->
		<script src="{{ asset('old/js/minified/jquery.swipebox.min.js') }}"></script>

		<!-- Expandable Gallery on 2 Block Column -->
		<script src="{{ asset('old/js/minified/expandableGallery.min.js') }}"></script>

		<!-- Counter Up -->
		<script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script>
		<script src="{{ asset('old/js/minified/jquery.counterup.min.js') }}"></script>

		<!-- Isotope JS -->
		<script src="https://npmcdn.com/isotope-layout@3.0/dist/isotope.pkgd.min.js"></script>
		<script src="{{ asset('old/js/urip-isotope-setting.js') }}"></script>

		<!-- Headhesive -->
		<script src="{{ asset('old/js/minified/headhesive.min.js') }}"></script>

		<!-- ScrollReveal -->
		<script src="{{ asset('old/js/minified/scrollReveal.min.js') }}"></script>

		<!-- Stellar JS -->
		<script src="{{ asset('old/js/jquery.stellar.js') }}"></script>

		<!-- Custom JS -->
		<script src="{{ asset('old/js/urip-v2.js') }}"></script>
