...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
	    ...
	    <title>Das neue Führen​ | Positive Psychologie für Führungskräfte</title>
	    ...
	    <!-- FAV AND TOUCH ICONS -->
	    <link rel="shortcut icon" href="{{ asset('old/images/favicon/favicon.ico') }}">

	    <link rel="icon" type="image/png" href="{{ asset('old/images/favicon/favicon-32.png') }}">
  	...
  	<body>
		...
		<nav id="nav-wrapper">
			...
			<ul id="main-nav" class="main-nav all-caps">
				...
				<li><a href="#crashkurs">Der Crashkurs​</a></li>
				<li><a href="#onlinetraining">Das Online-Training​</a></li>
                <li><a href="#intensivseminar">Das Intensivseminar​</a></li>
			...
			<section id="crashkurs" class="centered">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 centered">
							<p class="section-title">Z I E L <span style="margin: 0 10px;">|</span> S O F O R T  U M S E T Z B A R E S  W I S S E N​​</p>
					...
					<div class="row">
						...
						<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 centered">
							<p class="section-title">I N H A L T <span style="margin: 0 10px;">|</span> L I V E - S E S S I O N S​</p>
